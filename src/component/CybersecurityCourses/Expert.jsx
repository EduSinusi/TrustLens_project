  ...
  const courses = [
    {
      ...
      description: "A senior-level certification testing expertise in security architecture, risk management, and cryptography for experienced professionals.",
    ...
    },
    {
      ...
      description: "An advanced, hands-on certification focused on penetration testing and ethical hacking, ideal for offensive security roles.",
    ...
    },
    {
      ...
      description: "Targets expert-level risk management and governance, enhancing business resilience with a focus on IT security.",
    ...
    },
    {
      ...
      description: "An expert-level course on advanced penetration testing, red teaming, and exploit development for seasoned security professionals.",
    ...
    },
    {
      ...
      description: "Focuses on security management, governance, and program development for IT leaders with extensive experience.",
