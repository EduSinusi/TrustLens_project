  ...
  const courses = [
    {
      ...
      description: "An intermediate credential for designing and monitoring secure IT infrastructure, covering access controls and incident response.",
    ...
    },
    {
      ...
      description: "Focuses on threat detection, incident response, and vulnerability management, requiring some prior InfoSec experience.",
    ...
    },
    {
      ...
      description: "Covers incident response, threat analysis, and security tools, designed for those with basic IT knowledge.",
    ...
    },
    {
      ...
      description: "A hands-on course teaching security fundamentals, network monitoring, and incident handling for mid-level professionals.",
    ...
    },
    {
      ...
      description: "An intermediate course on ethical hacking techniques, penetration testing, and system vulnerabilities.",
