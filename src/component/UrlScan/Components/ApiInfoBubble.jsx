...
const apiLogos = {
 ...
 const apiDescriptions = {
   "Google Safe Browsing": "Google Safe Browsing helps protect users from dangerous sites by identifying threats like malware, phishing, and social engineering attacks.",
    "VirusTotal": "VirusTotal aggregates antivirus scans and URL analysis from multiple engines to detect malicious content.",
   "WHOIS Database": "WHOIS Database provides domain registration details, including creation date, owner information, and more.",
 };
 ...
 const ApiInfoBubble = ({ apiName }) => {
   return (
     <div className="relative group inline-block">
       ...
       {/* Info Bubble */}
       <div
         className="absolute hidden group-hover:block bg-gray-900 text-white text-xs rounded-lg p-3 w-90 top-0 left-6 z-50 shadow-lg"
       >
