...
const HeroSection = () => {
  return (
    <>
      <section className="relative h-[50vh] bg-gradient-to-b from-sky-600 to-gray-300  flex items-center justify-center overflow-hidden shadow-[0_10px_15px_-5px_rgba(0,0,0,0.3)] rounded-b-2xl mb-10">
